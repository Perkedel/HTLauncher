...
enum class ActionInternalCommand(@StringRes val id:Int = 0, @StringRes val label:Int = 0, @DrawableRes val image:Int = 0, val icon:ImageVector){
    ...
    Settings(id = R.string.internal_commands_settings, label = R.string.internal_commands_settings_label, image = R.drawable.settings, icon = Icons.Default.Settings),
    ...
    Aria(id = R.string.internal_commands_aria, label = R.string.internal_commands_aria_label, image = R.drawable.all_apps, icon = Icons.Default.Accessibility), // Read aloud label or aria field on click
    GoToPage(id = R.string.internal_commands_GoToPage, label = R.string.internal_commands_GoToPage_label, image = R.drawable.all_apps, icon = Icons.Default.Pages), // Go to page which in this homescreen
    OpenAPage(id = R.string.internal_commands_OpenAPage, label = R.string.internal_commands_OpenAPage_label, image = R.drawable.all_apps, icon = Icons.AutoMirrored.Default.MenuOpen), // Open a launcher page in a dialog
}